      ...
      <div className="container">
        ...
        <Reveal delay={0.16}>
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col items-start gap-3 border border-line bg-bg px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
              <span className="font-mono text-[0.62rem] uppercase tracking-[0.12em] text-muted">
                {t("services.s6name")}
              </span>
              <strong className="max-w-full font-mono text-[0.78rem] leading-relaxed text-ink sm:max-w-[28ch] sm:text-end">
                {t("pricing.rebrand")}
              </strong>
            </div>
            <div className="flex flex-col items-start gap-3 border border-line bg-bg px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
