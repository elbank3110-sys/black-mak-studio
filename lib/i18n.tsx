...
"statement.title":
  ...
  "pricing.1desc": "شعار احترافي يُبنى ليصبح جوهر العلامة التجارية المُعترف بها.",
  ...
  "pricing.3desc": "نظام بصري متكامل يمنح العلامة التجارية الاتساق والشخصية وفرصة للنمو.",
  "pricing.3a": "اكتشاف العلامة والتوجيه الإبداعي",
