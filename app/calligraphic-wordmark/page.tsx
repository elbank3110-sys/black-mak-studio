...
export const metadata: Metadata = {
  title: "Calligraphic Wordmarks â€” Custom Lettering for Brands | BLACK-MAK",
  description:
  ...
  openGraph: {
    title: "Calligraphic Wordmarks â€” BLACK-MAK",
    description:
      ...
      <section className="section">
        <div className="container narrow">
          ...
          <p className="lede mt-10">
            ...
            and its identity into one gesture: the name, drawn â€” not typed.
          </p>

          <div className="mt-14 space-y-8 text-muted">
            <p className="leading-relaxed">
              BLACK-MAK draws wordmarks by hand first â€” freestyle calligraphy in Arabic
              and Latin â€” then systematizes the chosen direction into production-ready
            ...
            <p className="leading-relaxed">
              ...
              the entire point of a wordmark â€” it cannot be copied, only commissioned.
            </p>
            <p className="leading-relaxed">
              Projects run in focused scopes: initial directions, refinement rounds,
              and editable final files (AI Â· PDF Â· PNG Â· SVG), with the studio&apos;s
          ...
          <figure className="mt-14 border border-line bg-surface">
            <Image
              ...
              alt="Arabic calligraphy study by BLACK-MAK â€” balance, rhythm, and contemporary letterform expression"
              width={1280}
              height={800}
            ...
            <figcaption className="border-t border-line px-5 py-3 font-mono text-[0.62rem] uppercase tracking-[0.13em] text-faint">
              Calligraphy studies â€” the stroke is both signal and structure.
            </figcaption>
          </figure>
        </div>
      </section>
